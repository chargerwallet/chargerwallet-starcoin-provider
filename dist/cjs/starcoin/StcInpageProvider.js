...
class StcInpageProvider extends BaseProvider_1.default {
    /**
        ...
        return new Proxy({
            ...
            requestBatch: (requests) => __awaiter(this, void 0, void 0, function* () {
                if (!Array.isArray(requests)) {
                    throw cross_inpage_provider_errors_1.web3Errors.rpc.invalidRequest({
...
exports.default = StcInpageProvider;
